class Feeling < ApplicationRecord
  ...
  scope :count_by_scale, ->(scale) { find_by_sql ["SELECT adjective, COUNT(*) AS count, :scale_id as SCALE_ID FROM feelings WHERE scale_id=:scale_id GROUP BY adjective ORDER BY count DESC;", {:scale_id => scale.id}] }
